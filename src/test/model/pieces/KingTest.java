...
public class KingTest {
    ...
    @Test
    void iconTest() {
        King whiteKing =  new King(1, board, board.getPos(3, 3));
        King blackKing =  new King(-1, board, board.getPos(4, 4));
    ...
    void getAvailablePositionsFromCenter() {
        King king =  new King(1, board, board.getPos(3, 3));
        board.getPos(3, 3).setPiece(king);
        ArrayList<Position> availPos = king.getAvailablePositions();
        assertEquals(8, availPos.size());
    }

    @Test
    void getAvailablePositionsFromEdge() {
        King king =  new King(1, board, board.getPos(4, 0));
    ...
    void getAvailablePositionsFromCorner() {
        King king =  new King(1, board, board.getPos(0, 0));
